...
#else
#error "You should define SSD1306_USE_SPI, SSD1306_USE_I2C or SSD1306_USE_SOFT_I2C macro!"
#endif
...
void SSD1306_UpdateRegion(uint8_t x, uint8_t y, uint8_t w, uint8_t h, uint8_t* data);
